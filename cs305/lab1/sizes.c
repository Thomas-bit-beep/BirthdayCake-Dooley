...
int main(int argv, char* argc[]) {
  long int longIntVar = 20;
  int intVar = 10;
  char charVar = 'a';
  double doubleVar = 25.78;
  long int * longIntPointer;
  int * intPointer;
  char * charPointer;
  double * doublePointer;
  
  int s_longInt = sizeof(longIntVar);
  int s_int = sizeof(intVar);
  int s_char = sizeof(charVar);
  int s_double = sizeof(doubleVar);
  int s_longIntPointer = sizeof(longIntPointer);
...
printf("Size of long int in bytes: %d\n", s_longInt);
  ...
  printf("Size of long int pointer in bytes: %d\n", s_longIntPointer);
